...
func TestDisableRac(t *testing.T) {
	fmt.Println ("TestDisableRac begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	logger.GetLogger().Log(logger.Debug, "TestDisableRac begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	logger.GetLogger().Log(logger.Debug, "TestDisableRac done  -------------------------------------------------------------")
}
