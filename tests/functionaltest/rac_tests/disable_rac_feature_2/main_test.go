...
/* #####################################################################################
 #  This test case tests rac feature disabled- rac_sql_interval = -1
 #######################################################################################*/

func TestDisableRac2(t *testing.T) {
	fmt.Println ("TestDisableRac2 begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	logger.GetLogger().Log(logger.Debug, "TestDisableRac2 begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	count := testutil.RegexCountFile (  "E.*RACMAINT_INFO_CHANGE", "cal.log")
        if ( count > 0 ) {
	...
	logger.GetLogger().Log(logger.Debug, "TestDisableRac2 done  -------------------------------------------------------------")
}
