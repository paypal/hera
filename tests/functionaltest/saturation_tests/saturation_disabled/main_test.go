...
func cfg() (map[string]string, map[string]string, testutil.WorkerType) {
	...
	appcfg["rac_sql_interval"] = "0"
        ...
        appcfg["opscfg.default.server.saturation_recover_throttle_rate"] = "0" //disable saturation
...
/*
 *   Verify saturation recovery does not kick in when saturation feature is disabled 
 */


func TestSaturationDisabled(t *testing.T) {
	fmt.Println ("TestSaturationDisabled begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	logger.GetLogger().Log(logger.Debug, "TestSaturationDisabled begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	logger.GetLogger().Log(logger.Debug, "TestSaturationDisabled done  -------------------------------------------------------------")
}
