...
/*
 *  Verify saturation is NOT triggered when when there is free worker
 */


func TestFreeWorkerNoSaturation(t *testing.T) {
	fmt.Println ("TestFreeWorkerNoSaturation begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	logger.GetLogger().Log(logger.Debug, "TestFreeWorkerNoSaturation begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	logger.GetLogger().Log(logger.Debug, "TestFreeWorkerNoSaturation done  -------------------------------------------------------------")
}
