...
func cfg() (map[string]string, map[string]string, testutil.WorkerType) {
	...
	appcfg["rac_sql_interval"] = "0"
        ...
        appcfg["opscfg.default.server.saturation_recover_threshold"] = "10000" //Set to big threshold
...
/*
 *  when saturation_recover_threshold is big, saturation protection almost cannot happen 
 */


func TestBigThresholdNoSaturation(t *testing.T) {
	fmt.Println ("TestBigThresholdNoSaturation begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	logger.GetLogger().Log(logger.Debug, "TestBigThresholdNoSaturation begin +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	fmt.Println ("Verify no SATURATION event is seen")
	...
	logger.GetLogger().Log(logger.Debug, "TestBigThresholdNoSaturation done  -------------------------------------------------------------")
}
