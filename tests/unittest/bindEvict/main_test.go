...
func TestBindEvict(t *testing.T) {
	...
	testutil.BackupAndClear("cal", "TestBindEvict start")
	testutil.BackupAndClear("hera", "TestBindEvict start")
	...
	if true {
		logger.GetLogger().Log(logger.Debug, "TestBindEvict midpt +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
	...
	logger.GetLogger().Log(logger.Debug, "TestBindEvict done +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n")
} // */
