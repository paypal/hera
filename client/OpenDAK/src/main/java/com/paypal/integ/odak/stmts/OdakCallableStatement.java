 ...
 * 
 * TODO: Write test case to run the stored procedure and make connection stale
 * in-between. Connection should be destroyed and not returned to the pool. I
 * don’t see cmProcessException kind of code in the existing
 * cmCallableStatementWrapper.java. How exceptions are handled today?
 * 
 * 
 * TODO: All check for isOpen() in all statements? If not added, we'll detect anyway if closed.
 * 
 * 
 */
public class OdakCallableStatement extends OdakPreparedStatement implements CallableStatement {
	private CallableStatement cStatement;
	private Connection conn;
	
	OdakCallableStatement(Connection conn, 
		CallableStatement callablestatement)
	{
		super(conn, callablestatement);
		this.conn = conn;
		this.cStatement = callablestatement;
	}
	...
	/**
	 * All below methods are unsupported today in cmconnectionwrapper.
	 * 
	 */
	@Override
