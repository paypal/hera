...
public class NetStringConstants {
	...
	// Cryptoserv Server Commands
	public final static long SAMPLE_CLIENT_PROTOCOL_NAME = 2002;
	public final static long SAMPLE_CLIENT_USERNAME = 2003;
}
