...
public final class OCCClientConfigHolder extends BaseOccConfiguration {
	...
	public static final String DEFAULT_CONNECTION_FACTORY="com.paypal.hera.conn.OccTCPConnectionFactory";
	//public static final String DEFAULT_CONNECTION_FACTORY="com.paypal.hera.conn.OccTLSConnectionFactory";
